...
const Pages = () => {
  ...
  const pageSaver = () => {
    ...
    Object(_providers_wallets__WEBPACK_IMPORTED_MODULE_5__["archivePage"])(pageDeets);
  };
  ...
  }, "Balance after transaction: ", parseFloat(typeof balance === 'string' ? balance : '0') - parseFloat(fee))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_2__["ModalFooter"], {
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 103,
...
const Pdfs = () => {
  ...
  const pdfSaver = () => {
    ...
    console.log(source);
    Object(_providers_wallets__WEBPACK_IMPORTED_MODULE_4__["archivePdf"])(pdfDeets);
  };
...
const Transfers = () => {
  ...
  const initiateTransfer = async () => {
    ...
    console.log(amount);
    Object(_providers_wallets__WEBPACK_IMPORTED_MODULE_2__["sendTransfer"])(transfterDeets);
  };
  ...
  }, "Balance after transaction: ", parseFloat(typeof balance === 'string' ? balance : '0') - parseFloat(fee))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_1__["ModalFooter"], {
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96,
...
const Wallets = () => {
  ...
  const WalletTable = () => {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_1__["List"], {
      spacing: 0,
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
  ...
  const Wallet = wallet => {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_1__["ListItem"], {
      border: "1px",
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
    ...
    }, wallet.balance, " AR"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_1__["Stack"], {
      isInline: true,
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
    ...
    }, "Use")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_chakra_ui_core__WEBPACK_IMPORTED_MODULE_1__["Stack"], {
      align: "center",
      justifyContent: "center",
      __self: undefined,
      __source: {
  ...
  const loadWallet = async () => {
    ...
    let res = await Object(_providers_wallets__WEBPACK_IMPORTED_MODULE_2__["addWallet"])(wallet, nickname);
    setProcessing(false);
  };
...
const addWallet = async (key, nickname) => {
...
const archivePage = async page => {
  ...
  let key = state.wallets.filter(wallet => wallet.address === state.activeWallet)[0].key;
